...
if (Config.WORKTYPE == 'private') {
  ...
  Jesi.adCmd({pattern: 'ip ?(.*)', desc: 'gives you the detail of your IP' ,fromMe: true}, async (message, match) => {
  ...
  Jesi.adCmd({pattern: 'ip ?(.*)', desc: 'gives you the detail of your IP' ,fromMe: false}, async (message, match) => {
