...
Jesi.adCmd({on: 'text', fromMe: true, deleteCommand: false}, (async (message, match) => {
...
Jesi.adCmd({pattern: 'afk ?(.*)', fromMe: true, deleteCommand: false, desc: Lang.AFK_DESC}, (async (message, match) => {     
    if (!AFK.isAfk) {
