...
if (Config.WORKTYPE == 'private') {
   Jesi.adCmd({ pattern: 'info', fromMe: true,  deleteCommand: false,  desc: Lang.INFO_DESC}, async (message, match) => { 
    ...
    Jesi.adCmd({ pattern: 'info', fromMe: false, desc: Lang.INFO_DESC}, async (message, match) => { 
